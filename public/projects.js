export const projects = [
  {
    ...
    description: 'Guide your kiwi down to safety before the time runs out! \n\nProject built to learn more about agentic coding techniques (aka vibe coding).',
