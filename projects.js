export const projects = [
  ...
  },
  {
    ...
    description: 'Built to help groups make decisions by voting on eachothers idaes, this project taught me a lot about about web sockets with socket.io, how to break down projects with spikes, data structures, one directional data flow which enables testing, designing using figma, and how to deploy the back-end with heroku and use github pages for the front-end.',
